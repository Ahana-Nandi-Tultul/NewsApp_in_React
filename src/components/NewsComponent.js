...
export class NewsComponent extends Component {
  ...
  fetchMoreData =async () => {
    console.log("cdm");
    const url = `https://newsapi.org/v2/top-headlines?apiKey=${this.props.apiKey}&country=${this.props.country}&category=${this.props.category}&page=${this.page+1}
    &pageSize=${this.props.pageSize}`;
  ...
  render() {
    return (
      <>
        <h1 className="text-center" style={{ marginTop: '90px', marginBottom:'35px'}}>
